                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('order.update') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" class="form-control" name="created_at" value="{{ $order->created_at }}"
                                            id="" placeholder="">
                                    </div>
             
                                    <div class="form-group">
                                        <label for="">Trận đấu</label>
                                        <input type="text" class="form-control" name="updated_at" value="{{ $order->id_match }}"
                                            id="" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="">SL ghế A</label>
                                        <input type="text" class="form-control" name="updated_at" value="{{ $order->numOfChairA }}"
                                            id="" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="">SL ghế B</label>
                                        <input type="text" class="form-control" name="updated_at" value="{{ $order->numOfChairB }}"
                                            id="" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="Tổng tiền ghế A"></label>
                                        <input type="text" class="form-control" name="updated_at" value="{{ $order->totalMoneyChairA }}"
                                            id="" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="Tổng tiền ghế B"></label>
                                        <input type="text" class="form-control" name="updated_at" value="{{ $order->totalMoneyChairB }}"
                                            id="" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="Tổng tiền "></label>
                                        <input type="text" class="form-control" name="updated_at" value="{{ $order->totalPrice }}"
                                            id="" placeholder="">
                                    </div>
